...
//gx(132,1) -- fill xgate_132 to 1st. window of the canvas
//gy(152,2) -- fill ygate_152 to 2nd. window of the canvas
//--ex.2
//newcanvas() -- create a canvas with (1,1)
//gx(132) -- fill xgate_132 to the canvas
//--ex.3
//gx(123) -- fill xgate_123 to current canvas.
