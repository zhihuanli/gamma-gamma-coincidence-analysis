...
- 1.[Generate gamma-gamma matrix(TH2) from a ROOT file(TTree)](https://github.com/zhihuanli/gamma-gamma-coincidence-analysis/blob/master/Gate2/root2hist.md)
- 2.[Generate background subtructed gamma-gamma matrix using Radware approch](https://github.com/zhihuanli/gamma-gamma-coincidence-analysis/blob/master/Gate2/hist2radware.md)
